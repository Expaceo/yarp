...
This is a fork of the YARP project to add support for TLS termination in the Kubernetes Ingress controller.
The combined ingress controller has been published to Docker Hub as `expaceo/yarp-ingress-controller:latest`.
